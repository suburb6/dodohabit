const ProductHuntPromoCard = ({ className = '' }) => {
    return (
        <div
            className={`not-prose w-full max-w-[500px] rounded-xl border border-[#e0e0e0] bg-white p-5 shadow-[0_2px_8px_rgba(0,0,0,0.05)] ${className}`}
        ...
        >
            <div className="mb-3 flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <p
                        className="mt-1 text-sm leading-snug text-[#666666]"
                        style={{
                            overflow: 'hidden',
                            display: '-webkit-box',
                            WebkitLineClamp: 2,
                    ...
                    >
                        Build Better Habits: One Day or Day One?
                    </p>
                </div>
            </div>
